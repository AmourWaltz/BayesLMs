...
import data 
import model_search_quant as model
...
# quant options
parser.add_argument('--quant', action='store_true', help='use Quantization')
parser.add_argument('--nbit', type=int, default=8,
                    help='quantize precision')
...
model = model.QuantTransModelSearch(ntokens, args.emsize, args.nhead, args.nhid,
