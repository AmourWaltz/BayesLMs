...
class Architect(object):
  ...
  def step(self,
          ...
          network_optimizer, unrolled, hiddens_valid=None):
    ...
    if unrolled:
      ...
      if hiddens_valid is None:
        self._backward_step(input_valid, target_valid)
      else:
        self._backward_step(input_valid, target_valid, hiddens_valid)
      pass

    self.optimizer.step()

  def _backward_step(self, input, target, hiddens=None):
    if hiddens is None:
      output = self.model.forward(input)
    else:
      hiddens = repackage_hidden(hiddens)
      output, hiddens = self.model.forward(input, hiddens)
    pass
